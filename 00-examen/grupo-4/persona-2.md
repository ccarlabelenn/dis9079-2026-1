...
---
## ¿Qué son?
- Conjunto de herramientas y reglas que permiten la comunicación y el intercambio de información simultánea entre diferentes programas y dispositivos de forma organizada.
- Permiten integrar datos, servicios y funcionalidades de otras aplicaciones, en lugar de desarrollarlos desde cero.
...
- Documnetación API: Manual instrucciones técnicas 
...
- Pueden funcionar de 4 maneras dsitintas según momento y motivo de creación
